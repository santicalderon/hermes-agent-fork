...
TERMINAL_TOOL_DESCRIPTION = "Execute shell commands. For builds, git, processes, and scripts."
...
TERMINAL_SCHEMA = {
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "background": {
                "type": "boolean",
                "description": "Run in background. Pair with notify_on_complete for long tasks. For servers/watchers.",
                "default": False
            },
            "timeout": {
                "type": "integer",
                "description": "Max seconds to wait (default: 180). Returns when command finishes.",
                "minimum": 1
            },
            "workdir": {
                "type": "string",
            ...
            "pty": {
                "type": "boolean",
                "description": "PTY mode for interactive CLIs (Codex, Claude Code, Python REPL). Only local/SSH.",
                "default": False
            },
            "notify_on_complete": {
                "type": "boolean",
                "description": "Notify on process finish. Use for long tasks. Exclusive with watch_patterns.",
                "default": False
            },
            "watch_patterns": {
                "type": "array",
                "items": {"type": "string"},
                "description": "Watch for patterns in bg process output. Rate limited: 1 notification/15s. For rare signals like startup complete.",
            }
        },
        "required": ["command"]
    }
