...
WEB_SEARCH_SCHEMA = {
    "name": "web_search",
    "description": "Search the web. Returns up to 5 results with URLs and descriptions. Supports operators (site:, filetype:, etc).",
    "parameters": {
        "type": "object",
        "properties": {
            "query": {
...
WEB_EXTRACT_SCHEMA = {
    "name": "web_extract",
    "description": "Extract content from web page URLs as markdown. Supports PDFs. Capped at ~5000 chars per page.",
    "parameters": {
        "type": "object",
        "properties": {
            "urls": {
