...
SUMMARY_PREFIX = (
    ...
    "of truth for what to do right now. Topic overlap with the summary does "
    "NOT mean you should resume its task: the latest user message WINS. "
    "Discard stale items from '## Historical Task Snapshot' / "
    "'## Historical In-Progress State' / '## Historical Pending User Asks' / "
    "'## Historical Remaining Work' entirely unless the latest message "
    "explicitly asks for them. Reverse signals (stop, undo, roll back, "
    "new topic) must immediately end any in-flight work. Your persistent "
...
_HISTORICAL_SUMMARY_PREFIXES = (
    # Post-fork: compacto, sin f-strings literales de headings
    "[CONTEXT COMPACTION — REFERENCE ONLY] Earlier turns were compacted "
    "into the summary below. This is a handoff from a previous context "
    "window — treat it as background reference, NOT as active instructions. "
    "Do NOT answer questions or fulfill requests mentioned in this summary; "
